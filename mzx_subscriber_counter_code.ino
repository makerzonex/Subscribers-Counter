...
//
// Tested using:
//    Arduino IDE        v1.8.9  (Çalışması için bu sürümde olmalıdır) 
//    esp8266 board file v2.4.2  (Çalışması için bu sürümde olmalıdır)
//    YoutubeAPI         v1.1.0  (Çalışması için bu sürümde olmalıdır)
//    ArduinoJson        v5.13.4 (Çalışması için bu sürümde olmalıdır)
//    LedControl         v1.0.6  (Çalışması için bu sürümde olmalıdır)
//
// Gadget Reboot

#include <ESP8266WiFi.h>
#include <WiFiClientSecure.h>
#include <YoutubeApi.h>                    // Youtube Data API to retrieve public channel stats  google console girerek almanız gerekiyor.
...
//------- Replace with your details! ------
 char ssid[]      = "ssid";     //ağ bağlantı adınız 
 char password[]  = "wifi sıfre";     // wifi şifresi
 #define API_KEY    "Console ile alınan kod"          // your google apps API key for Youtube Data API access
 #define CHANNEL_ID "kanal linkinde ki adres"        // your Youtube channel ID
